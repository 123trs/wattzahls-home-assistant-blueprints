# Felix Speicherkapitän – PV battery + dynamic tariff planning for Home Assistant
...
https://wattzahls.de/speicherkapitaen.html
...
Instead of blindly charging to 100%, the Speicherkapitän uses a simple model:
...
The Felix Speicherkapitän is intended as that understandable first layer.
